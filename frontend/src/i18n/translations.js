...
const translations = {
  en: {
    ...
    changePasswordOptional: 'Leave the password fields blank to keep your current password.',
  ...
  ar: {
    ...
    changePasswordOptional: 'اترك حقول كلمة المرور فارغة للاحتفاظ بكلمة المرور الحالية.',
